/****************************************************************************
** Meta object code from reading C++ file 'mQLabel.h'
**
...
#error "The header file 'mQLabel.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_mQLabel_t, stringdata0) + ofs \
...
void mQLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&mQLabel::Doubleclicked)) {
                *result = 0;
                return;
            }
        }
...
void *mQLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mQLabel.stringdata0))
